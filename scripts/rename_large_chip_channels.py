...
RENAMES = {
    "blue-chip-ticker": CHANNEL_BLUE_TICKER,
    "blue-chips": CHANNEL_BLUE_VOTE,
    "blue-chips-live": CHANNEL_BLUE_LIVE,
}
    ...
    async def on_ready(self) -> None:
        for guild in self.guilds:
            ...
            for old_name, new_name in RENAMES.items():
                ...
                if old_channel:
                    await old_channel.edit(name=new_name, reason="Rename blue chip channels to large chip")
